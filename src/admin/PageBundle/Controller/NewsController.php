...
use admin\PageBundle\Entity\News;
use admin\PageBundle\Form\NewsType;
...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('adminPageBundle:News')->findAll();

        return $this->render('adminPageBundle:News:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('adminPageBundle:News:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('adminPageBundle:News')->find($id);
        ...
        return $this->render('adminPageBundle:News:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('adminPageBundle:News:edit.html.twig', array(
            'entity'      => $entity,
