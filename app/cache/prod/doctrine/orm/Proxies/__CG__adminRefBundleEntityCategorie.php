...
namespace Proxies\__CG__\admin\RefBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Categorie extends \admin\RefBundle\Entity\Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'admin\\RefBundle\\Entity\\Categorie' . "\0" . 'id', '' . "\0" . 'admin\\RefBundle\\Entity\\Categorie' . "\0" . 'libelle', '' . "\0" . 'admin\\RefBundle\\Entity\\Categorie' . "\0" . 'description', '' . "\0" . 'admin\\RefBundle\\Entity\\Categorie' . "\0" . 'ordre', '' . "\0" . 'admin\\RefBundle\\Entity\\Categorie' . "\0" . 'visible', '' . "\0" . 'admin\\RefBundle\\Entity\\Categorie' . "\0" . 'Services');
        }
    ...
    public function hasService($service)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasService', array($service));

        return parent::hasService($service);
    }
