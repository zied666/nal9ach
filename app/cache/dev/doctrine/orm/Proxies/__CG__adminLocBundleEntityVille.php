 ...
 */
class Ville extends \admin\LocBundle\Entity\Ville implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'admin\\LocBundle\\Entity\\Ville' . "\0" . 'id', '' . "\0" . 'admin\\LocBundle\\Entity\\Ville' . "\0" . 'libelle', '' . "\0" . 'admin\\LocBundle\\Entity\\Ville' . "\0" . 'region');
        }
